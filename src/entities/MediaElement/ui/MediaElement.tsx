...
const baseUrlImg = "https://image.openmoviedb.com/kinopoisk-images/10671298/a1f5fc29-5309-4027-940b-ec12daa60421/orig"

export const MediaElement: FC<IMediaElement> = (props) => {
  const {
    name,
    alternativeName,
    poster,
  ...
  return (
    <div className="media-element">
      ...
      <Genre className="media-element__genre">
        {genres}
      </Genre>
      <div
