...
export const MediaDetails = () => {
  const [mediaDetails, setMediaDetails] = useState<IMediaElement | undefined>(
    undefined,
  );
  ...
  const movie = movies.find(
    (movie: IMediaElement) => movie.id === mediaIdNumber,
  );
  const serial = series.find(
    (serial: IMediaElement) => serial.id === mediaIdNumber,
  );
